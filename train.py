...
parser.add_argument('--arch', type=str, default='vgg19', action='store', help='select model architecture from VGG or DenseNet')
...
def main():
    ...
    torch.save(checkpoint, f'{args.save_dir}/{args.checkpoint}')
